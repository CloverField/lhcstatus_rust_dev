...
pub fn check_vistar_page_status() {
    ...
    match input {
        1 => get_vistar_page_status(Vistar::EntirePage),
        2 => get_vistar_page_status(Vistar::Comments),
        _ => println!("Please select a valid beam"),
    }
}

fn get_vistar_page_status(vistar: Vistar) {
